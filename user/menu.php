<ul class="sidebar-menu">
    ...
    <li><a class="nav-link" href="?pg=formulir"><i class="fas fa-file-archive"></i> <span>Formulir</span></a></li>
    ...
    <li><a class="nav-link" target="_blank" href="mod_formulir/print_kartu.php?id=<?= enkripsi($siswa['id_daftar']) ?>"><i class="fas fa-print"></i> <span>Cetak Kartu Peserta</span></a></li>
