        ...
        <div class="card author-box card-primary">
            <div class="card-header">
                ...
                <div class="card-header-action">
                    <a target="_blank" href="mod_formulir/print_daftar.php?id=<?= enkripsi($siswa['id_daftar']) ?>" type="button" class="btn btn-success">
                        <i class="fas fa-print"></i> Cetak Form
                    </a>

                    <a target="_blank" href="mod_formulir/print_kartu.php?id=<?= enkripsi($siswa['id_daftar']) ?>" type="button" class="btn btn-primary">
                        <i class="fas fa-credit-card"></i> Cetak Kartu Peserta
                    </a>
                    ...
                    <div class="tab-content" id="myTabContent2">
                        <div class="tab-pane fade show active" id="home3" role="tabpanel" aria-labelledby="home-tab3">
                            <form id="form-datadiri">
                                ...
                                <div class="form-group row mb-2">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Jurusan 1</label>
                                ...
                                <div class="form-group row mb-2">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Jurusan 2</label>
                                    <div class="col-sm-12 col-md-6">
                                        <input type="text" name="jurusan2" class="form-control" value="<?= $siswa['jurusan2'] ?>" disabled>
                                    </div>
                                </div>
